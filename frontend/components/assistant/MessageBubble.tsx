...
import { ChatBubble } from "@/components/daisyui-style";
...
export function MessageBubble({ message, isStreaming }: MessageBubbleProps) {
  ...
  return (
    <div
      className={cn(
        "message-slide-in flex w-full flex-col gap-1.5 will-change-[transform,opacity]",
    ...
    >
      ...
      {/* Main message bubble — DaisyUI chat pattern */}
      {(message.content || isStreaming || pa) && (
        <ChatBubble
          ...
          {pa && !isStreaming && (
            <a
              ...
              className={cn(
                ...
                "bg-white/15 text-white text-sm font-semibold ring-1 ring-white/25",
