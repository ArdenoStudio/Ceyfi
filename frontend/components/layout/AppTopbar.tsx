...
export function AppTopbar() {
  ...
  const demoAlerts = [
    {
      id: "1",
      title: t.topbar.householdSpend,
      body: t.topbar.householdSpendBody,
      when: t.topbar.justNow,
    },
    {
      id: "2",
      title: t.topbar.remittanceLanded,
      body: t.topbar.remittanceLandedBody,
      when: t.topbar.hoursAgo,
    },
    {
      id: "3",
      title: t.topbar.loanReminder,
      body: t.topbar.loanReminderBody,
      when: t.topbar.yesterday,
    },
  ];
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-background/88 px-4 backdrop-blur-xl md:hidden",
        scriptClassName
      )}
    >
      ...
      <div className="flex items-center gap-1">
        ...
        <Sheet>
          ...
          <SheetContent side="right" className={cn("w-[min(100%,20rem)]", scriptClassName)}>
            <SheetHeader>
              <SheetTitle>{t.common.alerts}</SheetTitle>
              <SheetDescription>{t.common.recentDemoNotifications}</SheetDescription>
            </SheetHeader>
