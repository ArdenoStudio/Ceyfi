...
export function GradientText({
  ...
  return (
    <motion.span
      className={`relative inline-flex max-w-fit items-center justify-center ${showBorder ? "rounded-[1.25rem] px-2 py-1" : ""} ${className}`}
    ...
    >
      ...
      <motion.span
        className="relative z-[1] inline-block bg-clip-text text-transparent"
        style={{
          ...gradientStyle,
          backgroundPosition,
