...
export default function LoansPage() {
  ...
  if (!loan) {
    return (
      <div className="dark min-h-full p-6" style={{ background: "#04241a" }}>
  ...
  return (
    <div data-module="loans" className="dark relative min-h-full overflow-hidden" style={{ background: "#04241a" }}>
